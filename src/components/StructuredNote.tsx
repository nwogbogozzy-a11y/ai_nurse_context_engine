    ...
    <Card className={cn(
      ...
      <CardContent className="px-5 py-5 space-y-4">
        {soapSections.map((section) => {
          ...
          return (
            <div key={section.key} className={cn(section.nested && 'pl-3 border-l-2 border-border')}>
              <span className={cn(
                'font-semibold uppercase tracking-widest text-secondary',
                section.nested ? 'text-xs' : 'text-xs'
              )}>
                {section.label}
              </span>
