...
- [x] 04-03-PLAN.md — Layout header, NurseSwitcher, FlagBadge, NurseActionBar, PatientCard migration
- [x] 04-04-PLAN.md — StructuredNote, DictationInput, SupplyChecklist, HandoffReport migration
- [x] 04-05-PLAN.md — ActivityTimeline, PatientContextSummary, ProcedureSearch migration
- [x] 04-06-PLAN.md — Page-level wiring: realtime subscriptions, shadcn Tabs, visual polish
**UI hint**: yes
